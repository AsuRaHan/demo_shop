 ...
 */
Route::get('/page/{page:slug}', [PageController::class, 'index'])->name('page.show');
...
Route::group([
    ...
    Route::get('brand/{brand:slug}', [CatalogController::class, 'brand'])
        ->name('brand');
    // страница товара каталога
    Route::get('product/{product:slug}', [CatalogController::class, 'product'])
        ->name('product');
...
Route::group([
    ...
    Route::post('profile', [BasketController::class, 'profile'])
        ->name('profile');
    // отправка данных формы для сохранения заказа в БД
    Route::post('saveorder', [BasketController::class, 'saveOrder'])
        ->name('saveorder');
    // страница после успешного сохранения заказа в БД
    Route::get('success', [BasketController::class, 'success'])
        ->name('success');
